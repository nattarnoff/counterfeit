...
app.innerHTML = app.innerHTML.replace('...', `
  ...
  <div class="cf-page">
    ...
    <header class="cf-hero" id="top">
      <div class="cf-page__main">
        <div class="cf-hero__content">
          <p><span class="cf-badge cf-badge--red">Accessibility-first system</span></p>
          <h1 class="cf-hero__title">A semantic, portable design system built white-on-black for readable, inclusive interfaces.</h1>
